...
public enum EnumMachineBeta implements IEnumMachine {
    ...
    BOILER_TANK_HIGH_PRESSURE(
            Module.STEAM, "boiler.tank.pressure.high", TileBoilerTankHigh.class, 2, 1, 0, 0, 1, 1, 1, 1),
    ...
    BOILER_FIREBOX_FLUID(
            Module.STEAM, "boiler.firebox.liquid", TileBoilerFireboxFluid.class, 3, 1, 0, 0, 1, 1, 1, 1, 2),
    ...
    TANK_STEEL_GAUGE(
            Module.TRANSPORT, "tank.steel.gauge", TileTankSteelGauge.class, 1, 5, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4),
