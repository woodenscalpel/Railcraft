...
public enum EnumMachineEta implements IEnumMachine {
    ...
    TANK_IRIDIUM_WALL(Module.ADVTANKS, "tank.iridium.wall", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_IRIDIUM,
            TileGenericMultiTankWall.class, 2, 1, 0, 0, 1, 1, 1, 1),
    TANK_IRIDIUM_GAUGE(Module.ADVTANKS, "tank.iridium.gauge", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_IRIDIUM,
            TileGenericMultiTankGauge.class, 1, 5, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4),
    TANK_IRIDIUM_VALVE(Module.ADVTANKS, "tank.iridium.valve", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_IRIDIUM,
            TileGenericMultiTankValve.class, 4, 1, 0, 0, 1, 1, 1, 1, 2, 3),
    TANK_OSMIUM_WALL(Module.ADVTANKS, "tank.osmium.wall", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_OSMIUM,
            TileGenericMultiTankWall.class, 2, 1, 0, 0, 1, 1, 1, 1),
    TANK_OSMIUM_GAUGE(Module.ADVTANKS, "tank.osmium.gauge", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_OSMIUM,
            TileGenericMultiTankGauge.class, 1, 5, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4),
    TANK_OSMIUM_VALVE(Module.ADVTANKS, "tank.osmium.valve", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_OSMIUM,
            TileGenericMultiTankValve.class, 4, 1, 0, 0, 1, 1, 1, 1, 2, 3),
    TANK_NEUTRONIUM_WALL(Module.ADVTANKS, "tank.neutronium.wall", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_NEUTRONIUM,
            TileGenericMultiTankWall.class, 2, 1, 0, 0, 1, 1, 1, 1),
    TANK_NEUTRONIUM_GAUGE(Module.ADVTANKS, "tank.neutronium.gauge", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_NEUTRONIUM,
            TileGenericMultiTankGauge.class, 1, 5, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4),
    TANK_NEUTRONIUM_VALVE(Module.ADVTANKS, "tank.neutronium.valve", ModuleAdvancedTanks.CAPACITY_PER_BLOCK_NEUTRONIUM,
            TileGenericMultiTankValve.class, 4, 1, 0, 0, 1, 1, 1, 1, 2, 3);
    ...
    private EnumMachineEta(Module module, String tag, int cap, Class<? extends TileMachineBase> tile,
            int... textureInfo) {
        this.module = module;
        this.tile = tile;
        this.tag = tag;
