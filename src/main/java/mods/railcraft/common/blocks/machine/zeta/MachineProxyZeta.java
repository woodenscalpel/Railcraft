 ...
 */
public class MachineProxyZeta implements IMachineProxy, IComparatorOverride {

    @Override
    public IEnumMachine getMachine(int meta) {
        return EnumMachineZeta.fromId(meta);
    }

    @Override
    public List<? extends IEnumMachine> getCreativeList() {
        return EnumMachineZeta.getCreativeList();
    }

    @Override
    public void registerIcons(IIconRegister iconRegister) {
        EnumMachineZeta.registerIcons(iconRegister);
    }
}
