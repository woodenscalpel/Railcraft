        ...
        for (EnumBlockMaterial mat : EnumBlockMaterial.VALUES) {
            if (BlockRailcraftSlab.isEnabled(mat) && mat.getSourceItem() != null) {
                switch (mat) {
                    case SNOW:
                        CraftingPlugin
                                .addShapedRecipe(BlockRailcraftSlab.getItem(mat, 3), "SSS", 'S', Blocks.snow_layer);
                        break;
                    default:
                        CraftingPlugin
                                .addShapedRecipe(BlockRailcraftSlab.getItem(mat, 6), "SSS", 'S', mat.getSourceItem());
                        CraftingPlugin
                                .addShapedRecipe(mat.getSourceItem(), "S", "S", 'S', BlockRailcraftSlab.getItem(mat));
                }
            }
        }
    }
