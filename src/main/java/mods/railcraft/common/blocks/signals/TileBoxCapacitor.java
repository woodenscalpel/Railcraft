...
public class TileBoxCapacitor extends TileBoxBase implements IGuiReturnHandler {
    ...
    public void updateEntity() {
        ...
        if (ticksPowered > 0) {
            ...
            if (stateModeController.getButtonState().equals(EnumStateMode.DELAYED)) { // new behavior
                ...
                if (PowerPlugin.isBlockBeingPoweredByRepeater(worldObj, xCoord, yCoord, zCoord)) hasInput = true;
            ...
            // in all cases:
            if (ticksPowered <= 0) updateNeighbors();
        }
    }
    ...
    public void onNeighborBlockChange(Block block) {
        ...
        if (ticksPowered <= 0 && p) {
            ...
            if (stateModeController.getButtonState().equals(EnumStateMode.IMMEDIATE)) aspect = SignalAspect.GREEN;
            updateNeighbors();
        }
    }
