...
public class ItemRail extends ItemRailcraft {
    ...
    public void defineRecipes() {
        ...
        RailcraftCraftingManager.rollingMachine.addRecipe(
                item.getStack(8, EnumRail.ADVANCED),
                "IRG",
                "IRG",
                "IRG",
                'I',
                item.getRecipeObject(EnumRail.STANDARD),
                'R',
        ...
        recipe = new ShapedOreRecipe(
                item.getStack(8, EnumRail.SPEED),
                "IBG",
                "IBG",
                "IBG",
                'I',
        ...
        // Electric
        recipe = new ShapedOreRecipe(
                item.getStack(6, EnumRail.ELECTRIC),
                "ICI",
                "ICI",
                "ICI",
                'I',
    ...
    public IIcon getIconFromDamage(int damage) {
        if (damage < 0 || damage >= EnumRail.VALUES.length) return EnumRail.STANDARD.icon;
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        if (damage < 0 || damage >= EnumRail.VALUES.length) return "";
