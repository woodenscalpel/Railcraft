        ...
        if (blockSignal != null) {
            ...
            if (RailcraftConfig.isSubBlockEnabled(structure.getTag())) {
                ...
                CraftingPlugin.addShapedRecipe(
                        ...
                        "   ",
                        'C',
                        RailcraftItem.circuit.getRecipeObject(ItemCircuit.EnumCircuit.SIGNAL),
                        'I',
                        "ingotIron",
                        'L',
            ...
            if (RailcraftConfig.isSubBlockEnabled(structure.getTag())) {
                ...
                CraftingPlugin.addShapedRecipe(
                        ...
                        RailcraftItem.circuit.getRecipeObject(ItemCircuit.EnumCircuit.SIGNAL),
                        'R',
                        RailcraftItem.circuit.getRecipeObject(ItemCircuit.EnumCircuit.RECEIVER),
                        'I',
                        "ingotIron",
                        'L',
                        RailcraftItem.signalLamp.getRecipeObject(),
            ...
            if (RailcraftConfig.isSubBlockEnabled(structure.getTag())) {
                ...
                CraftingPlugin.addShapedRecipe(
                        ...
                        "dustRedstone",
                        'C',
                        RailcraftItem.circuit.getRecipeObject(ItemCircuit.EnumCircuit.CONTROLLER));
            }
