    ...
    public void initSecond() {
        ...
        if (blockPost != null) {
            ...
            CraftingPlugin.addShapedRecipe(
                    ...
                    " I ",
                    'T',
                    BlockRailcraftSlab.getItem(EnumBlockMaterial.CREOSOTE),
                    'I',
                    EnumPost.WOOD.getItem());

            CraftingPlugin.addShapedRecipe(
                    EnumPost.STONE.getItem(8),
                    "SIS",
                    "SIS",
                    "SIS",
                    'I',
                    ...
                    "stone");
            CraftingPlugin.addShapedRecipe(
                    EnumPost.STONE_PLATFORM.getItem(),
                    " T ",
                    " I ",
                    'T',
                    BlockRailcraftSlab.getItem(EnumBlockMaterial.CONCRETE),
                    'I',
                    EnumPost.STONE.getItem());

            ItemStack stack = EnumPost.METAL_UNPAINTED.getItem(16);

            IRecipe recipe = new ShapedOreRecipe(stack, "III", " I ", "III", 'I', "ingotIron");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);

            recipe = new ShapedOreRecipe(stack, "I I", "III", "I I", 'I', "ingotIron");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);

            CraftingPlugin.addShapedRecipe(
                    EnumPost.METAL_PLATFORM_UNPAINTED.getItem(4),
                    " T ",
                    " I ",
                    'T',
                    BlockRailcraftSlab.getItem(EnumBlockMaterial.IRON),
                    'I',
                    EnumPost.METAL_UNPAINTED.getItem());

            stack = EnumPost.METAL_UNPAINTED.getItem(32);
            recipe = new ShapedOreRecipe(stack, "III", " I ", "III", 'I', "ingotSteel");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);

            recipe = new ShapedOreRecipe(stack, "I I", "III", "I I", 'I', "ingotSteel");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);

            stack = EnumPost.METAL_UNPAINTED.getItem(12);
            recipe = new ShapedOreRecipe(stack, "III", " I ", "III", 'I', "ingotBronze");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);
            recipe = new ShapedOreRecipe(stack, "I I", "III", "I I", 'I', "ingotBronze");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);

            stack = EnumPost.METAL_UNPAINTED.getItem(20);
            recipe = new ShapedOreRecipe(stack, "III", " I ", "III", 'I', "ingotRefinedIron");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);
            recipe = new ShapedOreRecipe(stack, "I I", "III", "I I", 'I', "ingotRefinedIron");
            RollingMachineCraftingManager.getInstance().getRecipeList().add(recipe);
        }
        ...
        if (BlockStrengthGlass.getBlock() != null) {
            ...
            for (ItemStack container : FluidHelper.getContainersFilledWith(water)) {
                for (Object frame : frameTypes) {
                    CraftingPlugin.addShapedRecipe(
                            BlockStrengthGlass.getItem(6, 0),
                            "GFG",
                            "GSG",
                            "GWG",
                            'G',
