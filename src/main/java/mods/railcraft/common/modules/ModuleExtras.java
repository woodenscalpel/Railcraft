...
public class ModuleExtras extends RailcraftModule {
    ...
    public void initFirst() {
        ...
        if (cart.setup()) {
            CraftingPlugin.addShapedRecipe(cart.getCartItem(), "WTW", "WWW", 'T', Blocks.tnt, 'W', "slabWood");
        ...
        cart = EnumCart.WORK;
        if (cart.setup()) {
            CraftingPlugin.addShapedRecipe(cart.getCartItem(), "B", "M", 'B', "craftingTableWood", 'M', Items.minecart);
