    ...
    public void initFirst() {
        ...
        if (cart.setup()) {
            ...
            if (month == Calendar.OCTOBER || month == Calendar.NOVEMBER) {
                ...
                CraftingPlugin.addShapedRecipe(
                        cart.getCartItem(),
                        new Object[] { "GGG", "WPW", "WWW", 'G', new ItemStack(Items.gunpowder), 'P',
                                new ItemStack(Blocks.pumpkin), 'W', "slabWood" });
            }
        }
        ...
        if (cart.setup()) {
            ...
            if (month == Calendar.DECEMBER || month == Calendar.JANUARY) {
                ...
                CraftingPlugin.addShapedRecipe(
                        cart.getCartItem(),
                        new Object[] { "GGG", "WEW", "WWW", 'G', new ItemStack(Items.gunpowder), 'E', "gemEmerald", 'W',
                                "slabWood" });
            }
        }
    }
