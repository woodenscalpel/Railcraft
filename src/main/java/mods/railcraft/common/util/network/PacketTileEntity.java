    ...
    public void readData(DataInputStream data) throws IOException {
        ...
        if (tile == null) {
            ...
            if (blockTrack != null && blockTrack == block) {
                ...
                if (te instanceof RailcraftTileEntity) tile = (RailcraftTileEntity) te;
            }
        }
        ...
        try {
            ...
            if (Game.IS_DEBUG) throw ex;
            else Game.logThrowable("Exception in PacketTileEntity.readData:", ex);
        }
    }
