    ...
    public void onCrafting(ItemCraftedEvent event) {
        ...
        if (cartItem != null) {
            ...
            if (type != null && EnumCart.getCartType(result) == EnumCart.getCartType(cartItem)) {
                ...
                if (filterItem != null) for (IInvSlot slot : InventoryIterator.getIterable(craftMatrix).notNull()) {
            ...
            if (count == 1 && EnumCart.getCartType(result) == EnumCart.BASIC) {
                ...
                if (contents != null) if (!player.inventory.addItemStackToInventory(contents))
