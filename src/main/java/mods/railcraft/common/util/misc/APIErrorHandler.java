 ...
 *
 * Generally, new API functions should be surround by try/catch blocks that catch <code>Error</code> throws. This
 * ensures that the game doesn't crash if the incorrect API version is loaded first.
 *
