...
public class RenderTrackBuffer extends TileEntitySpecialRenderer {
    ...
    //    }
    //
    //    public static void render(RenderBlocks render, TrackBufferStop track, IBlockAccess world, int x, int y, int z,
    // int meta) {
    //
    ////        if (meta == 0) {
    ////            if (!track.isReversed()) {
    ...
    private static ResourceLocation TEXTURE =
            new ResourceLocation(RailcraftConstants.TESR_TEXTURE_FOLDER + "track_buffer_stop.png");
