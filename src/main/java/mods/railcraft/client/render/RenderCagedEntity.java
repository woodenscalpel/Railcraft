...
public class RenderCagedEntity extends TileEntitySpecialRenderer {
    ...
    public void render(TileCage tile, double x, double y, double z, float time) {
        ...
        if (entity != null) {
            ...
            // GL11.glRotatef((float) (par0MobSpawnerBaseLogic.field_98284_d +
            // (par0MobSpawnerBaseLogic.field_98287_c - par0MobSpawnerBaseLogic.field_98284_d) * (double) par7) * 10.0F,
            // 0.0F, 1.0F, 0.0F);
