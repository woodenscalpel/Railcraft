...
public class GuiCartTrackLayer extends EntityGui {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        fontRendererObj.drawString(
                LocalizationPlugin.translate("railcraft.gui.cart.track.relayer.pattern"), 38, 30, 0x404040);
        fontRendererObj.drawString(
                LocalizationPlugin.translate("railcraft.gui.cart.track.relayer.stock"), 125, 25, 0x404040);
        fontRendererObj.drawString(
