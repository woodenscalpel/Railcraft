...
public interface IBoreHead {
     ...
     *
     * This value is compared against the tool classes "pickaxe", "axe", and "shovel" to determine if the block is
     * harvestable by the bore head.
     *
     ...
     *
     * This value controls how much faster or slow this bore head mines each layer compared to the default time.
     *
