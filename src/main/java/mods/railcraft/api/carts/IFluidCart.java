...
public interface IFluidCart {
    ...
    /**
     * This function controls whether a cart will accept a pushed Fluid. Even if this function returns true, there still
     * must be a tank that accepts the Fluid in question before it can be added to the cart.
     * <p/>
