 ...
 * @deprecated This class has been depreciated in favor of a more general system that doesn't require a cart to
 *             implement anything. This interface is no longer used.
 */
@Deprecated
public interface IItemTransfer {

    /**
     * Offers an ItemStack to the object implementing this interface. This function will return null if the item is
     * accepted in full, otherwise it will return whatever is rejected.
     *
    ...
    /**
     * Requests an ItemStack from the object implementing this interface. It is up to the object implementing this
     * interface to determine which ItemStack to return, or none at all.
     *
    ...
    /**
     * Requests an ItemStack from the object implementing this interface that matches the request parameter. It is up to
     * the object implementing this interface to determine which ItemStack to return, or none at all. However, if the
     * return value is not null it should fulfill the following condition:<br/>
