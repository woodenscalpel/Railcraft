...
public interface ITrackSwitch extends ITrackInstance {
    ...
    /**
     * Returns whether the switch track should "appear" switched. Has no influence on where a cart actually ends up.
    ...
    /**
     * Switch Tracks have an additional orientation state beyond normal tracks. This function returns that value.
     *
